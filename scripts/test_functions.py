from functions import explore_tree, dict_to_xml, list_path_folder, computation_area_over_time, clustering_cells, computation_area_over_time_volume
...
def test_xml_reading():
    """
    Test the reading and generation of an XML file by converting it to a dictionary and back.
    """
...
def test_list_path_folder(): 
    """
    Test if the number of output files generated by PhysiCell matches the expected number based on simulation settings.
    """
...
def test_computation_area_over_time_volume():
    expected_area = 47600
    dt = 2 #hours
    ...
    area_over_time = computation_area_over_time_volume(result_mat, dt)
